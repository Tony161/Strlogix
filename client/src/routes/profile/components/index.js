    ...
    return (
        <div>
          ...
          {!this.state.isEdit ?  (
            ...
            <div style={{fontSize:"1.5em", marginLeft:"60px", marginTop:"3em"}}>
                  <div>First Name<input type="text" defaultValue={this.props.profile.firstName} ref={this.firstName} /></div>
                  <div>Last Name<input type="text" defaultValue={this.props.profile.lastName} ref={this.lastName} /></div>
                  <div>Title<input type="text" defaultValue={this.props.profile.title} ref={this.title} /></div>
                  <div>Email</div>
                  <div>Role</div>
              </div>
          )}
